...
#include "FirstPersonGameMode__pf205484891.h"
...
AFirstPersonCharacter_C__pf205484891::AFirstPersonCharacter_C__pf205484891(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__ItemGrip__pf = CreateDefaultSubobject<USceneComponent>(TEXT("ItemGrip"));
	...
	bpv__ItemGrip__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__ItemGrip__pf->AttachToComponent(bpv__FirstPersonCamera__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__21 = (*(AccessPrivateProperty<FVector >((bpv__ItemGrip__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__21 = FVector(109.484436, -1.752765, -4.248421);
	(((FBoolProperty*)__Local__19)->SetPropertyValue_InContainer((bpv__ItemGrip__pf), false, 0));
	...
	auto& __Local__22 = (*(AccessPrivateProperty<float >(&(bpv__VR_Gun__pf->BodyInstance), FBodyInstance::__PPO__MassInKgOverride() )));
	__Local__22 = 0.000000f;
	auto& __Local__23 = (*(AccessPrivateProperty<FRotator >((bpv__VR_Gun__pf), USceneComponent::__PPO__RelativeRotation() )));
	...
	auto& __Local__24 = (*(AccessPrivateProperty<float >(&(bpv__VR_Marker__pf->BodyInstance), FBodyInstance::__PPO__MassInKgOverride() )));
	__Local__24 = 0.307177f;
	auto& __Local__25 = (*(AccessPrivateProperty<FVector >((bpv__VR_Marker__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__25 = FVector(0.000004, 53.999992, 10.000000);
	auto& __Local__26 = (*(AccessPrivateProperty<FRotator >((bpv__VR_Marker__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__26 = FRotator(0.000000, 89.999992, 0.000000);
	auto& __Local__27 = (*(AccessPrivateProperty<FVector >((bpv__VR_Marker__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__27 = FVector(0.117650, 0.117650, 0.114726);
	...
	bpv__LookAtActor__pf = nullptr;
	bpv__CurrentlyHeldItem__pf = nullptr;
	bpv__LookAtDistance__pf = 250.000000f;
	bpv__HUD__pf = nullptr;
	bpv__MainMenu__pf = TSoftObjectPtr<UWorld> (FSoftObjectPath(TEXT("/Game/Scenes/Gate_2_Levels/MainMenuLevel.MainMenuLevel")));
...
void AFirstPersonCharacter_C__pf205484891::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AFirstPersonGameMode_C__pf205484891::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(ABP_ItemParent_C__pf476478934::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(UHeadsUpDisplay_C__pf1489439355::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
	auto __Local__32 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("SceneComponent_0"), (EObjectFlags)0x00280029);
	...
	auto __Local__34 = NewObject<UInputActionDelegateBinding>(InDynamicClass, UInputActionDelegateBinding::StaticClass(), TEXT("InputActionDelegateBinding_1"), (EObjectFlags)0x00000000);
	...
	__Local__33->InputAxisDelegateBindings.AddUninitialized(6);
	FBlueprintInputAxisDelegateBinding::StaticStruct()->InitializeStruct(__Local__33->InputAxisDelegateBindings.GetData(), 6);
	auto& __Local__37 = __Local__33->InputAxisDelegateBindings[0];
	__Local__37.InputAxisName = FName(TEXT("Turn"));
	__Local__37.FunctionNameToBind = FName(TEXT("InpAxisEvt_Turn_K2Node_InputAxisEvent_157"));
	__Local__37.bOverrideParentBinding = false;
	auto& __Local__38 = __Local__33->InputAxisDelegateBindings[1];
	__Local__38.InputAxisName = FName(TEXT("LookUp"));
	__Local__38.FunctionNameToBind = FName(TEXT("InpAxisEvt_LookUp_K2Node_InputAxisEvent_172"));
	__Local__38.bOverrideParentBinding = false;
	auto& __Local__39 = __Local__33->InputAxisDelegateBindings[2];
	__Local__39.InputAxisName = FName(TEXT("MoveForward"));
	__Local__39.FunctionNameToBind = FName(TEXT("InpAxisEvt_MoveForward_K2Node_InputAxisEvent_181"));
	__Local__39.bConsumeInput = false;
	__Local__39.bOverrideParentBinding = false;
	auto& __Local__40 = __Local__33->InputAxisDelegateBindings[3];
	__Local__40.InputAxisName = FName(TEXT("MoveRight"));
	__Local__40.FunctionNameToBind = FName(TEXT("InpAxisEvt_MoveRight_K2Node_InputAxisEvent_192"));
	__Local__40.bConsumeInput = false;
	__Local__40.bOverrideParentBinding = false;
	auto& __Local__41 = __Local__33->InputAxisDelegateBindings[4];
	__Local__41.InputAxisName = FName(TEXT("TurnRate"));
	__Local__41.FunctionNameToBind = FName(TEXT("InpAxisEvt_TurnRate_K2Node_InputAxisEvent_34"));
	auto& __Local__42 = __Local__33->InputAxisDelegateBindings[5];
	__Local__42.InputAxisName = FName(TEXT("LookUpRate"));
	__Local__42.FunctionNameToBind = FName(TEXT("InpAxisEvt_LookUpRate_K2Node_InputAxisEvent_62"));
	__Local__34->InputActionDelegateBindings = TArray<FBlueprintInputActionDelegateBinding> ();
	__Local__34->InputActionDelegateBindings.AddUninitialized(5);
	FBlueprintInputActionDelegateBinding::StaticStruct()->InitializeStruct(__Local__34->InputActionDelegateBindings.GetData(), 5);
	auto& __Local__43 = __Local__34->InputActionDelegateBindings[0];
	__Local__43.InputActionName = FName(TEXT("ResetVR"));
	__Local__43.FunctionNameToBind = FName(TEXT("InpActEvt_ResetVR_K2Node_InputActionEvent_4"));
	auto& __Local__44 = __Local__34->InputActionDelegateBindings[1];
	__Local__44.InputActionName = FName(TEXT("Interact"));
	__Local__44.FunctionNameToBind = FName(TEXT("InpActEvt_Interact_K2Node_InputActionEvent_3"));
	auto& __Local__45 = __Local__34->InputActionDelegateBindings[2];
	__Local__45.InputActionName = FName(TEXT("QuitGame"));
	__Local__45.FunctionNameToBind = FName(TEXT("InpActEvt_QuitGame_K2Node_InputActionEvent_0"));
	auto& __Local__46 = __Local__34->InputActionDelegateBindings[3];
	__Local__46.InputActionName = FName(TEXT("MainMenu"));
	__Local__46.FunctionNameToBind = FName(TEXT("InpActEvt_MainMenu_K2Node_InputActionEvent_1"));
	auto& __Local__47 = __Local__34->InputActionDelegateBindings[4];
	__Local__47.InputActionName = FName(TEXT("Cancel"));
	__Local__47.FunctionNameToBind = FName(TEXT("InpActEvt_Cancel_K2Node_InputActionEvent_2"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	AddMovementInput(TSwitchValue<bool , FVector >(b0l__Temp_bool_Variable_1__pf, b0l__K2Node_Select_Default_1__pf, 2, TSwitchPair<bool , FVector >(false, bpfv__CallFunc_GetActorForwardVector_ReturnValue__pf), TSwitchPair<bool , FVector >(true, bpfv__CallFunc_GetForwardVector_ReturnValue__pf)), b0l__K2Node_InputAxisEvent_AxisValue_2__pf, false);
...
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	UGameplayStatics::OpenLevelBySoftObjectPtr(this, bpv__MainMenu__pf, true, FString(TEXT("")));
	return; // KCST_GotoReturn
}
...
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_3(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	AddControllerPitchInput(b0l__K2Node_InputAxisEvent_AxisValue_1__pf);
	return; // KCST_GotoReturn
}
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_4(int32 bpp__EntryPoint__pf)
{
	...
	AddMovementInput(TSwitchValue<bool , FVector >(b0l__Temp_bool_Variable__pf, b0l__K2Node_Select_Default__pf, 2, TSwitchPair<bool , FVector >(false, bpfv__CallFunc_GetActorRightVector_ReturnValue__pf), TSwitchPair<bool , FVector >(true, bpfv__CallFunc_GetRightVector_ReturnValue__pf)), b0l__K2Node_InputAxisEvent_AxisValue_3__pf, false);
	return; // KCST_GotoReturn
}
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_5(int32 bpp__EntryPoint__pf)
{
	...
	b0l__K2Node_DynamicCast_AsFirst_Person_Game_Mode__pf = Cast<AFirstPersonGameMode_C__pf205484891>(bpfv__CallFunc_GetGameMode_ReturnValue__pf);
	b0l__K2Node_DynamicCast_bSuccess_2__pf = (b0l__K2Node_DynamicCast_AsFirst_Person_Game_Mode__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess_2__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	UHeadsUpDisplay_C__pf1489439355*  __Local__48 = ((UHeadsUpDisplay_C__pf1489439355*)nullptr);
	bpv__HUD__pf = ((::IsValid(b0l__K2Node_DynamicCast_AsFirst_Person_Game_Mode__pf)) ? (b0l__K2Node_DynamicCast_AsFirst_Person_Game_Mode__pf->bpv__HeadsUpDisplayWidget__pf) : (__Local__48));
...
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_6(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 20:
			{
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(bpv__LookAtActor__pf);
		...
		case 21:
			{
				if ( bpv__LookAtActor__pf && bpv__LookAtActor__pf->GetClass()->ImplementsInterface(UInteract_Interface_C::StaticClass()) )
				{
					b0l__K2Node_DynamicCast_AsInteract_Interface__pf.SetObject(bpv__LookAtActor__pf);
					void* IAddress = bpv__LookAtActor__pf->GetInterfaceAddress(UInteract_Interface_C::StaticClass());
					b0l__K2Node_DynamicCast_AsInteract_Interface__pf.SetInterface(IAddress);
				}
				else
				{
					b0l__K2Node_DynamicCast_AsInteract_Interface__pf.SetObject(nullptr);
				}
				b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsInteract_Interface__pf != nullptr);;
		...
		case 22:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsInteract_Interface__pf))
				{
					IInteract_Interface_C::Execute_bpf__InteractWith__pf(b0l__K2Node_DynamicCast_AsInteract_Interface__pf.GetObject() , this);
				}
				__CurrentState = -1;
				break;
			}
		case 23:
			{
				if ( bpv__CurrentlyHeldItem__pf && bpv__CurrentlyHeldItem__pf->GetClass()->ImplementsInterface(UInteract_Interface_C::StaticClass()) )
				{
					b0l__K2Node_DynamicCast_AsInteract_Interface_1__pf.SetObject(bpv__CurrentlyHeldItem__pf);
					void* IAddress = bpv__CurrentlyHeldItem__pf->GetInterfaceAddress(UInteract_Interface_C::StaticClass());
					b0l__K2Node_DynamicCast_AsInteract_Interface_1__pf.SetInterface(IAddress);
				}
				else
				{
					b0l__K2Node_DynamicCast_AsInteract_Interface_1__pf.SetObject(nullptr);
				}
				b0l__K2Node_DynamicCast_bSuccess_1__pf = (b0l__K2Node_DynamicCast_AsInteract_Interface_1__pf != nullptr);;
		...
		case 24:
			{
				if(::IsValid(b0l__K2Node_DynamicCast_AsInteract_Interface_1__pf))
				{
					IInteract_Interface_C::Execute_bpf__InteractWith__pf(b0l__K2Node_DynamicCast_AsInteract_Interface_1__pf.GetObject() , this);
				}
				__CurrentState = -1;
				break;
			}
...
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_7(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(bpv__CurrentlyHeldItem__pf);
	if (!bpfv__CallFunc_IsValid_ReturnValue__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	if(::IsValid(bpv__CurrentlyHeldItem__pf))
	{
		bpv__CurrentlyHeldItem__pf->bpf__DropItem__pf();
	}
	bpv__CurrentlyHeldItem__pf = ((ABP_ItemParent_C__pf476478934*)nullptr);
	return; // KCST_GotoReturn
}
...
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_9(int32 bpp__EntryPoint__pf)
{
	...
	// optimized KCST_UnconditionalGoto
	bpf__CheckLookAt__pf(/*out*/ b0l__CallFunc_CheckLookAt_LookAtActor__pf);
	return; // KCST_GotoReturn
}
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_10(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_2__pf = UKismetMathLibrary::Multiply_FloatFloat(b0l__K2Node_InputAxisEvent_AxisValue_4__pf, bpv__BaseTurnRate__pf);
	bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_3__pf = UKismetMathLibrary::Multiply_FloatFloat(bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_2__pf, bpfv__CallFunc_GetWorldDeltaSeconds_ReturnValue_1__pf);
	AddControllerYawInput(bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_3__pf);
	return; // KCST_GotoReturn
}
void AFirstPersonCharacter_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonCharacter__pf_11(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_FloatFloat(b0l__K2Node_InputAxisEvent_AxisValue_5__pf, bpv__BaseLookUpRate__pf);
	...
	AddControllerPitchInput(bpfv__CallFunc_Multiply_FloatFloat_ReturnValue_1__pf);
	return; // KCST_GotoReturn
}
...
void AFirstPersonCharacter_C__pf205484891::bpf__InpAxisEvt_Turn_K2Node_InputAxisEvent_157__pf(float bpp__AxisValue__pf)
{
	...
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_2(35);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpAxisEvt_LookUp_K2Node_InputAxisEvent_172__pf(float bpp__AxisValue__pf)
{
	...
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_3(33);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpAxisEvt_MoveForward_K2Node_InputAxisEvent_181__pf(float bpp__AxisValue__pf)
{
	...
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_0(31);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpAxisEvt_MoveRight_K2Node_InputAxisEvent_192__pf(float bpp__AxisValue__pf)
{
	...
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_4(29);
}
void AFirstPersonCharacter_C__pf205484891::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_9(26);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpAxisEvt_TurnRate_K2Node_InputAxisEvent_34__pf(float bpp__AxisValue__pf)
{
	...
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_10(17);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpAxisEvt_LookUpRate_K2Node_InputAxisEvent_62__pf(float bpp__AxisValue__pf)
{
	...
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_11(15);
}
void AFirstPersonCharacter_C__pf205484891::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_5(9);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpActEvt_QuitGame_K2Node_InputActionEvent_0__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_12(8);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpActEvt_MainMenu_K2Node_InputActionEvent_1__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key_1__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_1(6);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpActEvt_Cancel_K2Node_InputActionEvent_2__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key_2__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_7(2);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpActEvt_Interact_K2Node_InputActionEvent_3__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key_3__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_6(19);
}
void AFirstPersonCharacter_C__pf205484891::bpf__InpActEvt_ResetVR_K2Node_InputActionEvent_4__pf(FKey bpp__Key__pf)
{
	b0l__K2Node_InputActionEvent_Key_4__pf = bpp__Key__pf;
	bpf__ExecuteUbergraph_FirstPersonCharacter__pf_8(28);
}
void AFirstPersonCharacter_C__pf205484891::bpf__CheckLookAt__pf(/*out*/ AActor*& bpp__LookAtActor__pf)
{
	TScriptInterface<IInteract_Interface_C> bpfv__K2Node_DynamicCast_AsInteract_Interface__pf{};
	bool bpfv__K2Node_DynamicCast_bSuccess__pf{};
	TArray<AActor*> bpfv__Temp_object_Variable__pf{};
	bool bpfv__CallFunc_UpdateMessage_IsVisible__pf{};
	...
	do
	{
		...
		case 1:
			{
				if(::IsValid(bpv__FirstPersonCamera__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__FirstPersonCamera__pf->USceneComponent::K2_GetComponentLocation();
				}
				if(::IsValid(bpv__FirstPersonCamera__pf))
				{
					bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf = bpv__FirstPersonCamera__pf->USceneComponent::K2_GetComponentRotation();
				}
				...
				bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorFloat(bpfv__CallFunc_GetForwardVector_ReturnValue__pf, bpv__LookAtDistance__pf);
				...
				bpfv__CallFunc_LineTraceSingle_ReturnValue__pf = UKismetSystemLibrary::LineTraceSingle(this, bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_Add_VectorVector_ReturnValue__pf, ETraceTypeQuery::TraceTypeQuery2, false, bpfv__Temp_object_Variable__pf, EDrawDebugTrace::None, /*out*/ bpfv__CallFunc_LineTraceSingle_OutHit__pf, true, FLinearColor(0.000000,0.000000,0.000000,0.000000), FLinearColor(0.000000,1.000000,0.000000,0.000000), 0.000000);
			}
		case 2:
			{
				...
				bpfv__CallFunc_DoesImplementInterface_ReturnValue__pf = UKismetSystemLibrary::DoesImplementInterface(bpfv__CallFunc_BreakHitResult_HitActor__pf, UInteract_Interface_C::StaticClass());
		...
		case 3:
			{
				UGameplayStatics::BreakHitResult(bpfv__CallFunc_LineTraceSingle_OutHit__pf, /*out*/ bpfv__CallFunc_BreakHitResult_bBlockingHit__pf, /*out*/ bpfv__CallFunc_BreakHitResult_bInitialOverlap__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Time__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Distance__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Location__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ImpactPoint__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Normal__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ImpactNormal__pf, /*out*/ bpfv__CallFunc_BreakHitResult_PhysMat__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitActor__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitComponent__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitBoneName__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitItem__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ElementIndex__pf, /*out*/ bpfv__CallFunc_BreakHitResult_FaceIndex__pf, /*out*/ bpfv__CallFunc_BreakHitResult_TraceStart__pf, /*out*/ bpfv__CallFunc_BreakHitResult_TraceEnd__pf);
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(bpfv__CallFunc_BreakHitResult_HitActor__pf, bpv__LookAtActor__pf);
		...
		case 4:
			{
				bpv__LookAtActor__pf = ((AActor*)nullptr);
			}
		case 5:
			{
				if(::IsValid(bpv__HUD__pf))
				{
					bpv__HUD__pf->bpf__UpdateMessage__pf(FText::GetEmpty(), /*out*/ bpfv__CallFunc_UpdateMessage_IsVisible__pf);
				}
			}
		case 6:
			{
				bpp__LookAtActor__pf = bpv__LookAtActor__pf;
				__CurrentState = -1;
				break;
			}
		case 7:
			{
				UGameplayStatics::BreakHitResult(bpfv__CallFunc_LineTraceSingle_OutHit__pf, /*out*/ bpfv__CallFunc_BreakHitResult_bBlockingHit__pf, /*out*/ bpfv__CallFunc_BreakHitResult_bInitialOverlap__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Time__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Distance__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Location__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ImpactPoint__pf, /*out*/ bpfv__CallFunc_BreakHitResult_Normal__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ImpactNormal__pf, /*out*/ bpfv__CallFunc_BreakHitResult_PhysMat__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitActor__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitComponent__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitBoneName__pf, /*out*/ bpfv__CallFunc_BreakHitResult_HitItem__pf, /*out*/ bpfv__CallFunc_BreakHitResult_ElementIndex__pf, /*out*/ bpfv__CallFunc_BreakHitResult_FaceIndex__pf, /*out*/ bpfv__CallFunc_BreakHitResult_TraceStart__pf, /*out*/ bpfv__CallFunc_BreakHitResult_TraceEnd__pf);
				bpv__LookAtActor__pf = bpfv__CallFunc_BreakHitResult_HitActor__pf;
			}
		case 8:
			{
				if ( bpv__LookAtActor__pf && bpv__LookAtActor__pf->GetClass()->ImplementsInterface(UInteract_Interface_C::StaticClass()) )
				{
					bpfv__K2Node_DynamicCast_AsInteract_Interface__pf.SetObject(bpv__LookAtActor__pf);
					void* IAddress = bpv__LookAtActor__pf->GetInterfaceAddress(UInteract_Interface_C::StaticClass());
					bpfv__K2Node_DynamicCast_AsInteract_Interface__pf.SetInterface(IAddress);
				}
				else
				{
					bpfv__K2Node_DynamicCast_AsInteract_Interface__pf.SetObject(nullptr);
				}
				bpfv__K2Node_DynamicCast_bSuccess__pf = (bpfv__K2Node_DynamicCast_AsInteract_Interface__pf != nullptr);;
		...
		case 9:
			{
				if(::IsValid(bpfv__K2Node_DynamicCast_AsInteract_Interface__pf))
				{
					IInteract_Interface_C::Execute_bpf__LookAt__pf(bpfv__K2Node_DynamicCast_AsInteract_Interface__pf.GetObject() , this);
				}
			}
		case 10:
			{
...
void AFirstPersonCharacter_C__pf205484891::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{42, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.CameraComponent 
		...
		{43, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/HeadMountedDisplay.MotionControllerComponent 
		{44, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.SkeletalMeshComponent 
		...
		{51, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.Character 
		...
		{54, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Enum /Script/InputCore.ETouchIndex 
		...
		{37, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/Engine.FormatArgumentData 
		...
		{35, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/FirstPersonBP/Blueprints/Interact_Interface.Interact_Interface_C 
		{68, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/FirstPersonBP/Blueprints/FirstPersonGameMode.FirstPersonGameMode_C 
		{69, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/Blueprints/Items/BP_ItemParent.BP_ItemParent_C 
