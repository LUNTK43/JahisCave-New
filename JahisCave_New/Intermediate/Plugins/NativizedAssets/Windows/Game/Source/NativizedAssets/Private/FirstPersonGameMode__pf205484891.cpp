...
AFirstPersonGameMode_C__pf205484891::AFirstPersonGameMode_C__pf205484891(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	bpv__HeadsUpDisplayWidget__pf = nullptr;
	HUDClass = AFirstPersonHUD_C__pf205484891::StaticClass();
	DefaultPawnClass = AFirstPersonCharacter_C__pf205484891::StaticClass();
...
void AFirstPersonGameMode_C__pf205484891::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AFirstPersonGameMode_C__pf205484891::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(AFirstPersonHUD_C__pf205484891::StaticClass());
	InDynamicClass->ReferencedConvertedFields.Add(AFirstPersonCharacter_C__pf205484891::StaticClass());
	FConvertedBlueprintsDependencies::FillUsedAssetsInDynamicClass(InDynamicClass, &__StaticDependencies_DirectlyUsedAssets);
}
PRAGMA_ENABLE_OPTIMIZATION
void AFirstPersonGameMode_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonGameMode__pf_0(int32 bpp__EntryPoint__pf)
{
	int32 bpfv__CallFunc_Len_ReturnValue__pf{};
	int32 bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf{};
	FString bpfv__CallFunc_GetSubstring_ReturnValue__pf{};
	AActor* bpfv__CallFunc_K2_FindPlayerStart_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 5);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Len_ReturnValue__pf = UKismetStringLibrary::Len(OptionsString);
	bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(bpfv__CallFunc_Len_ReturnValue__pf, 1);
	bpfv__CallFunc_GetSubstring_ReturnValue__pf = UKismetStringLibrary::GetSubstring(OptionsString, 1, bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf);
	bpfv__CallFunc_K2_FindPlayerStart_ReturnValue__pf = AGameModeBase::K2_FindPlayerStart(b0l__K2Node_Event_NewPlayer__pf, bpfv__CallFunc_GetSubstring_ReturnValue__pf);
	RestartPlayerAtPlayerStart(b0l__K2Node_Event_NewPlayer__pf, bpfv__CallFunc_K2_FindPlayerStart_ReturnValue__pf);
	return; // KCST_GotoReturn
}
void AFirstPersonGameMode_C__pf205484891::bpf__ExecuteUbergraph_FirstPersonGameMode__pf_1(int32 bpp__EntryPoint__pf)
{
	UHeadsUpDisplay_C__pf1489439355* bpfv__CallFunc_Create_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 2);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UHeadsUpDisplay_C__pf1489439355>(UWidgetBlueprintLibrary::Create(this, UHeadsUpDisplay_C__pf1489439355::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	bpv__HeadsUpDisplayWidget__pf = bpfv__CallFunc_Create_ReturnValue__pf;
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__HeadsUpDisplayWidget__pf))
	{
		bpv__HeadsUpDisplayWidget__pf->UUserWidget::AddToViewport(0);
	}
	return; // KCST_GotoReturn
}
void AFirstPersonGameMode_C__pf205484891::HandleStartingNewPlayer_Implementation(APlayerController* bpp__NewPlayer__pf)
{
	b0l__K2Node_Event_NewPlayer__pf = bpp__NewPlayer__pf;
	bpf__ExecuteUbergraph_FirstPersonGameMode__pf_0(5);
}
void AFirstPersonGameMode_C__pf205484891::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_FirstPersonGameMode__pf_1(2);
}
PRAGMA_DISABLE_OPTIMIZATION
void AFirstPersonGameMode_C__pf205484891::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AFirstPersonGameMode_C__pf205484891::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{47, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.GameModeBase 
		...
		{70, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/FirstPersonBP/Blueprints/FirstPersonHUD.FirstPersonHUD_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AFirstPersonGameMode_C__pf205484891
{
	FRegisterHelper__AFirstPersonGameMode_C__pf205484891()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/FirstPersonBP/Blueprints/FirstPersonGameMode"), &AFirstPersonGameMode_C__pf205484891::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AFirstPersonGameMode_C__pf205484891 Instance;
};
FRegisterHelper__AFirstPersonGameMode_C__pf205484891 FRegisterHelper__AFirstPersonGameMode_C__pf205484891::Instance;
