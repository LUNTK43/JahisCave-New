...
UHeadsUpDisplay_C__pf1489439355::UHeadsUpDisplay_C__pf1489439355(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	
	bpv__MessageBox__pf = nullptr;
...
void UHeadsUpDisplay_C__pf1489439355::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UHeadsUpDisplay_C__pf1489439355::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__3->LayoutData.Offsets.Left = -48.937820f;
	__Local__3->LayoutData.Offsets.Top = -150.000000f;
	__Local__3->LayoutData.Offsets.Right = 260.160156f;
	...
	auto __Local__4 = NewObject<UBorder>(__Local__0, TEXT("MessageBox"), (EObjectFlags)0x00280008);
	...
	__Local__4->Padding.Left = 30.000000f;
	__Local__4->Padding.Top = 10.000000f;
	__Local__4->Padding.Right = 30.000000f;
	__Local__4->Padding.Bottom = 10.000000f;
	__Local__4->BrushColor = FLinearColor(0.463542, 0.463542, 0.463542, 0.800000);
	...
	__Local__7.Left = 30.000000f;
	__Local__7.Top = 10.000000f;
	__Local__7.Right = 30.000000f;
	__Local__7.Bottom = 10.000000f;
	auto& __Local__8 = (*(AccessPrivateProperty<TEnumAsByte<EHorizontalAlignment> >((__Local__6), UBorderSlot::__PPO__HorizontalAlignment() )));
	__Local__8 = EHorizontalAlignment::HAlign_Center;
	auto& __Local__9 = (*(AccessPrivateProperty<TEnumAsByte<EVerticalAlignment> >((__Local__6), UBorderSlot::__PPO__VerticalAlignment() )));
	__Local__9 = EVerticalAlignment::VAlign_Center;
	__Local__6->Parent = __Local__4;
	auto __Local__10 = NewObject<UTextBlock>(__Local__0, TEXT("MessageText"), (EObjectFlags)0x00280008);
	__Local__10->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[9F6EABC847AE52EC4CFA588BF7B993C3]\", \"455AD68A4B7CB295AE58E493AC215B0B\", \"Placeholder Text\")")	);
	...
	__Local__10->Slot = __Local__6;
	__Local__10->bIsVariable = true;
	__Local__6->Content = __Local__10;
...
PRAGMA_ENABLE_OPTIMIZATION
void UHeadsUpDisplay_C__pf1489439355::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__12;
	SlotNames.Append(__Local__12);
}
void UHeadsUpDisplay_C__pf1489439355::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__13;
	TArray<FDelegateRuntimeBinding>  __Local__14;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UHeadsUpDisplay_C__pf1489439355::StaticClass())->MiscConvertedSubobjects[0]), __Local__13, __Local__14);
}
void UHeadsUpDisplay_C__pf1489439355::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UHeadsUpDisplay_C__pf1489439355::bpf__ExecuteUbergraph_HeadsUpDisplay__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpv__PlayerCharacter__pf = b0l__K2Node_DynamicCast_AsFirst_Person_Character__pf;
	// optimized KCST_UnconditionalGoto
	bpf__UpdateMessage__pf(FText::GetEmpty(), /*out*/ b0l__CallFunc_UpdateMessage_IsVisible__pf);
	return; // KCST_GotoReturn
}
void UHeadsUpDisplay_C__pf1489439355::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_HeadsUpDisplay__pf_0(2);
}
void UHeadsUpDisplay_C__pf1489439355::bpf__UpdateMessage__pf(const FText& bpp__TextToDisplay__pf__const, /*out*/ bool& bpp__IsVisible__pf)
{
	typedef FText  T__Local__15;
	T__Local__15& bpp__TextToDisplay__pf = *const_cast<T__Local__15 *>(&bpp__TextToDisplay__pf__const);
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_MakeLiteralText_ReturnValue__pf = UKismetSystemLibrary::MakeLiteralText(FText::GetEmpty());
				bpfv__CallFunc_EqualEqual_TextText_ReturnValue__pf = UKismetTextLibrary::EqualEqual_TextText(bpp__TextToDisplay__pf, bpfv__CallFunc_MakeLiteralText_ReturnValue__pf);
		...
		case 2:
			{
				ABP_ItemParent_C__pf476478934*  __Local__16 = ((ABP_ItemParent_C__pf476478934*)nullptr);
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(((::IsValid(bpv__PlayerCharacter__pf)) ? (bpv__PlayerCharacter__pf->bpv__CurrentlyHeldItem__pf) : (__Local__16)));
		...
		case 3:
			{
				bpfv__K2Node_MakeStruct_FormatArgumentData__pf.ArgumentName = FString(TEXT("name"));
				...
				bpfv__K2Node_MakeStruct_FormatArgumentData__pf.ArgumentValue = ((::IsValid(bpv__PlayerCharacter__pf) && ::IsValid(bpv__PlayerCharacter__pf->bpv__CurrentlyHeldItem__pf)) ? (bpv__PlayerCharacter__pf->bpv__CurrentlyHeldItem__pf->bpv__ItemName__pf) : (__Local__17));
...
TEXT("NSLOCTEXT(\"[9F6EABC847AE52EC4CFA588BF7B993C3]\", \"1047126349C3328022A6D382E935DBB4\", \"Press E to Inspect {name}\\r\\nPress R to Drop the Item\")")	), bpfv__K2Node_MakeArray_Array__pf);
				if(::IsValid(bpv__MessageText__pf))
				{
					bpv__MessageText__pf->SetText(bpfv__CallFunc_Format_ReturnValue__pf);
				}
			}
		case 4:
			{
				if(::IsValid(bpv__MessageBox__pf))
				{
					bpv__MessageBox__pf->SetVisibility(ESlateVisibility::Visible);
				}
			}
		case 5:
			{
				bpp__IsVisible__pf = true;
				__CurrentState = -1;
				break;
			}
		case 6:
			{
				if(::IsValid(bpv__MessageText__pf))
				{
					bpv__MessageText__pf->SetText(bpp__TextToDisplay__pf);
				}
			}
		case 7:
			{
		...
		case 9:
			{
				if(::IsValid(bpv__MessageBox__pf))
				{
					bpv__MessageBox__pf->SetVisibility(ESlateVisibility::Hidden);
				}
			}
		case 10:
			{
				bpp__IsVisible__pf = false;
				__CurrentState = -1;
				break;
			}
		default:
...
PRAGMA_DISABLE_OPTIMIZATION
void UHeadsUpDisplay_C__pf1489439355::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UHeadsUpDisplay_C__pf1489439355::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{57, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UMG.Border 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UHeadsUpDisplay_C__pf1489439355
{
	FRegisterHelper__UHeadsUpDisplay_C__pf1489439355()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/UI/HeadsUpDisplay"), &UHeadsUpDisplay_C__pf1489439355::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UHeadsUpDisplay_C__pf1489439355 Instance;
};
FRegisterHelper__UHeadsUpDisplay_C__pf1489439355 FRegisterHelper__UHeadsUpDisplay_C__pf1489439355::Instance;
