...
#include "InspectionScreen_Backup__pf1489439355.h"
...
UInspectionScreen_Backup_C__pf1489439355::UInspectionScreen_Backup_C__pf1489439355(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void UInspectionScreen_Backup_C__pf1489439355::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void UInspectionScreen_Backup_C__pf1489439355::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__5 = CastChecked<UObject>(CastChecked<UDynamicClass>(UInspectionScreen_Backup_C__pf1489439355::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	...
	__Local__6->LayoutData.Offsets.Left = -50.000000f;
	__Local__6->LayoutData.Offsets.Top = 50.000000f;
	...
	__Local__6->LayoutData.Alignment = FVector2D(1.000000, 0.000000);
	__Local__6->bAutoSize = true;
	__Local__6->Parent = __Local__1;
	auto __Local__7 = NewObject<UBorder>(__Local__0, TEXT("Border_0"), (EObjectFlags)0x00280008);
	__Local__7->Padding.Left = 30.000000f;
	__Local__7->Padding.Top = 10.000000f;
	__Local__7->Padding.Right = 30.000000f;
	__Local__7->Padding.Bottom = 10.000000f;
	__Local__7->BrushColor = FLinearColor(0.203125, 0.203125, 0.203125, 0.800000);
	...
	__Local__10.Left = 30.000000f;
	__Local__10.Top = 10.000000f;
	__Local__10.Right = 30.000000f;
	__Local__10.Bottom = 10.000000f;
	__Local__9->Parent = __Local__7;
	auto __Local__11 = NewObject<UGridPanel>(__Local__0, TEXT("GridPanel_289"), (EObjectFlags)0x00280008);
	...
	__Local__12.Reserve(6);
	auto __Local__13 = NewObject<UGridSlot>(__Local__11, TEXT("GridSlot_0"), (EObjectFlags)0x00280008);
	__Local__13->HorizontalAlignment = EHorizontalAlignment::HAlign_Right;
	__Local__13->Parent = __Local__11;
	auto __Local__14 = NewObject<UTextBlock>(__Local__0, TEXT("TextBlock_114"), (EObjectFlags)0x00280008);
	__Local__14->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3889E0CE44DF1EA0469EB3BE0A1D8883]\", \"E9DCC67C43073BCA94F79298797F5A06\", \"Press E:\")")	);
	__Local__14->Slot = __Local__13;
	__Local__13->Content = __Local__14;
	__Local__12.Add(__Local__13);
	auto __Local__15 = NewObject<UGridSlot>(__Local__11, TEXT("GridSlot_1"), (EObjectFlags)0x00280008);
	__Local__15->Padding.Left = 20.000000f;
	__Local__15->Column = 1;
	__Local__15->Parent = __Local__11;
	auto __Local__16 = NewObject<UTextBlock>(__Local__0, TEXT("TextBlock_228"), (EObjectFlags)0x00280008);
	__Local__16->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3889E0CE44DF1EA0469EB3BE0A1D8883]\", \"ABEE2A054ACB2E398CBBEF8537C9C885\", \"Leave Inspection\")")	);
	__Local__16->Slot = __Local__15;
	__Local__15->Content = __Local__16;
	__Local__12.Add(__Local__15);
	auto __Local__17 = NewObject<UGridSlot>(__Local__11, TEXT("GridSlot_2"), (EObjectFlags)0x00280008);
	__Local__17->HorizontalAlignment = EHorizontalAlignment::HAlign_Right;
	__Local__17->Row = 1;
	__Local__17->Parent = __Local__11;
	auto __Local__18 = NewObject<UTextBlock>(__Local__0, TEXT("TextBlock_348"), (EObjectFlags)0x00280008);
	__Local__18->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3889E0CE44DF1EA0469EB3BE0A1D8883]\", \"864271E646200F6307BBD3B5A8006EB9\", \"Mouse Wheel:\")")	);
	__Local__18->Slot = __Local__17;
	__Local__17->Content = __Local__18;
	__Local__12.Add(__Local__17);
	auto __Local__19 = NewObject<UGridSlot>(__Local__11, TEXT("GridSlot_6"), (EObjectFlags)0x00280008);
	__Local__19->Padding.Left = 20.000000f;
	__Local__19->Row = 1;
	__Local__19->Column = 1;
	__Local__19->Parent = __Local__11;
	auto __Local__20 = NewObject<UTextBlock>(__Local__0, TEXT("TextBlock_444"), (EObjectFlags)0x00280008);
	__Local__20->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3889E0CE44DF1EA0469EB3BE0A1D8883]\", \"F10E26BF4F5B4C7C22E19B8A0141C53C\", \"Zoom In/Out\")")	);
	__Local__20->Slot = __Local__19;
	__Local__19->Content = __Local__20;
	__Local__12.Add(__Local__19);
	auto __Local__21 = NewObject<UGridSlot>(__Local__11, TEXT("GridSlot_4"), (EObjectFlags)0x00280008);
	__Local__21->HorizontalAlignment = EHorizontalAlignment::HAlign_Right;
	__Local__21->Row = 2;
	__Local__21->Parent = __Local__11;
	auto __Local__22 = NewObject<UTextBlock>(__Local__0, TEXT("TextBlock_545"), (EObjectFlags)0x00280008);
	__Local__22->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3889E0CE44DF1EA0469EB3BE0A1D8883]\", \"51107D2F492C5B1DA0FAA79C661A0399\", \"LeftClick & Drag:\")")	);
	__Local__22->Slot = __Local__21;
	__Local__21->Content = __Local__22;
	__Local__12.Add(__Local__21);
	auto __Local__23 = NewObject<UGridSlot>(__Local__11, TEXT("GridSlot_5"), (EObjectFlags)0x00280008);
	__Local__23->Padding.Left = 20.000000f;
	__Local__23->Row = 2;
	__Local__23->Column = 1;
	__Local__23->Parent = __Local__11;
	auto __Local__24 = NewObject<UTextBlock>(__Local__0, TEXT("TextBlock_629"), (EObjectFlags)0x00280008);
	__Local__24->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3889E0CE44DF1EA0469EB3BE0A1D8883]\", \"35E91C254C526E85C9DC1AAC11DDE614\", \"Rotate\")")	);
	...
	auto __Local__25 = NewObject<UCanvasPanelSlot>(__Local__1, TEXT("CanvasPanelSlot_11"), (EObjectFlags)0x00280008);
	__Local__25->LayoutData.Offsets.Left = 1316.000000f;
	__Local__25->LayoutData.Offsets.Top = 252.000000f;
	__Local__25->LayoutData.Offsets.Right = 551.562683f;
	__Local__25->LayoutData.Offsets.Bottom = 491.562683f;
	__Local__25->Parent = __Local__1;
	auto __Local__26 = NewObject<UImage>(__Local__0, TEXT("Image_153"), (EObjectFlags)0x00280008);
	auto& __Local__27 = (*(AccessPrivateProperty<UObject* >(&(__Local__26->Brush), FSlateBrush::__PPO__ResourceObject() )));
	__Local__27 = CastChecked<UObject>(CastChecked<UDynamicClass>(UInspectionScreen_Backup_C__pf1489439355::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	__Local__26->Slot = __Local__25;
	__Local__25->Content = __Local__26;
	__Local__2.Add(__Local__25);
	auto __Local__28 = NewObject<UCanvasPanelSlot>(__Local__1, TEXT("CanvasPanelSlot_1"), (EObjectFlags)0x00280008);
	__Local__28->LayoutData.Offsets.Left = -50.000000f;
	__Local__28->LayoutData.Offsets.Top = 250.000000f;
	__Local__28->LayoutData.Offsets.Right = 560.000000f;
	__Local__28->LayoutData.Offsets.Bottom = 500.000000f;
	__Local__28->LayoutData.Anchors.Minimum = FVector2D(1.000000, 0.000000);
	__Local__28->LayoutData.Anchors.Maximum = FVector2D(1.000000, 0.000000);
	__Local__28->LayoutData.Alignment = FVector2D(1.000000, 0.000000);
	__Local__28->Parent = __Local__1;
	auto __Local__29 = NewObject<UBorder>(__Local__0, TEXT("Border_107"), (EObjectFlags)0x00280008);
	__Local__29->BrushColor = FLinearColor(0.203125, 0.203125, 0.203125, 0.800000);
	...
	auto __Local__31 = NewObject<UBorderSlot>(__Local__29, TEXT("BorderSlot_0"), (EObjectFlags)0x00280008);
	__Local__31->Parent = __Local__29;
	auto __Local__32 = NewObject<UScrollBox>(__Local__0, TEXT("ScrollB"), (EObjectFlags)0x00280008);
	...
	auto __Local__34 = NewObject<UScrollBoxSlot>(__Local__32, TEXT("ScrollBoxSlot_0"), (EObjectFlags)0x00280008);
	__Local__34->Padding.Left = 30.000000f;
	__Local__34->Padding.Top = 10.000000f;
	__Local__34->Padding.Right = 30.000000f;
	__Local__34->Padding.Bottom = 10.000000f;
	__Local__34->Parent = __Local__32;
	auto __Local__35 = NewObject<UTextBlock>(__Local__0, TEXT("ItemDescriptionText"), (EObjectFlags)0x00280008);
	__Local__35->Text = FTextStringHelper::CreateFromBuffer(
TEXT("NSLOCTEXT(\"[3889E0CE44DF1EA0469EB3BE0A1D8883]\", \"B25C09D8466BB8E6A4438A991814B24C\", \"Item Description\")")	);
	auto& __Local__36 = (*(AccessPrivateProperty<float >((__Local__35), UTextLayoutWidget::__PPO__WrapTextAt() )));
	__Local__36 = 500.000000f;
	...
	__Local__2.Add(__Local__28);
	__Local__0->RootWidget = __Local__1;
}
PRAGMA_ENABLE_OPTIMIZATION
void UInspectionScreen_Backup_C__pf1489439355::GetSlotNames(TArray<FName>& SlotNames) const
{
	TArray<FName>  __Local__37;
	SlotNames.Append(__Local__37);
}
void UInspectionScreen_Backup_C__pf1489439355::InitializeNativeClassData()
{
	TArray<UWidgetAnimation*>  __Local__38;
	TArray<FDelegateRuntimeBinding>  __Local__39;
	UWidgetBlueprintGeneratedClass::InitializeWidgetStatic(this, GetClass(), CastChecked<UWidgetTree>(CastChecked<UDynamicClass>(UInspectionScreen_Backup_C__pf1489439355::StaticClass())->MiscConvertedSubobjects[0]), __Local__38, __Local__39);
}
void UInspectionScreen_Backup_C__pf1489439355::PreSave(const class ITargetPlatform* TargetPlatform)
{
...
void UInspectionScreen_Backup_C__pf1489439355::bpf__ExecuteUbergraph_InspectionScreen_Backup__pf_0(int32 bpp__EntryPoint__pf)
{
...
void UInspectionScreen_Backup_C__pf1489439355::bpf__ExecuteUbergraph_InspectionScreen_Backup__pf_1(int32 bpp__EntryPoint__pf)
{
...
void UInspectionScreen_Backup_C__pf1489439355::bpf__StopScroll__pf()
{
	bpf__ExecuteUbergraph_InspectionScreen_Backup__pf_1(26);
}
void UInspectionScreen_Backup_C__pf1489439355::bpf__StartScroll__pf()
{
	bpf__ExecuteUbergraph_InspectionScreen_Backup__pf_1(25);
}
void UInspectionScreen_Backup_C__pf1489439355::bpf__Tick__pf(FGeometry bpp__MyGeometry__pf, float bpp__InDeltaTime__pf)
{
	b0l__K2Node_Event_MyGeometry__pf = bpp__MyGeometry__pf;
	b0l__K2Node_Event_InDeltaTime__pf = bpp__InDeltaTime__pf;
	bpf__ExecuteUbergraph_InspectionScreen_Backup__pf_1(24);
}
void UInspectionScreen_Backup_C__pf1489439355::bpf__Construct__pf()
{
	bpf__ExecuteUbergraph_InspectionScreen_Backup__pf_0(21);
}
PRAGMA_DISABLE_OPTIMIZATION
void UInspectionScreen_Backup_C__pf1489439355::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void UInspectionScreen_Backup_C__pf1489439355::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__UInspectionScreen_Backup_C__pf1489439355
{
	FRegisterHelper__UInspectionScreen_Backup_C__pf1489439355()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/UI/InspectionScreen_Backup"), &UInspectionScreen_Backup_C__pf1489439355::__StaticDependenciesAssets);
	}
	static FRegisterHelper__UInspectionScreen_Backup_C__pf1489439355 Instance;
};
FRegisterHelper__UInspectionScreen_Backup_C__pf1489439355 FRegisterHelper__UInspectionScreen_Backup_C__pf1489439355::Instance;
