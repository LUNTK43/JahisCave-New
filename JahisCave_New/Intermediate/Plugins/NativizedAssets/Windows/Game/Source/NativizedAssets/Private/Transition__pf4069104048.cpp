...
#include "Transition__pf4069104048.h"
...
ATransition_C__pf4069104048::ATransition_C__pf4069104048(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	bpv__DoorCollider__pf = CreateDefaultSubobject<UBoxComponent>(TEXT("DoorCollider"));
	...
	__Local__2 = FVector(32.000000, 150.000000, 250.000000);
	...
	__Local__3 = FVector(0.000000, 0.000000, 250.000000);
	...
	auto& __Local__4 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Door__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__4 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ATransition_C__pf4069104048::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Door__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Door__pf->OverrideMaterials.Reserve(1);
	bpv__Door__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ATransition_C__pf4069104048::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	auto& __Local__5 = (*(AccessPrivateProperty<FVector >((bpv__Door__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__5 = FVector(0.000000, 0.000000, 260.000000);
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__Door__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__6 = FVector(1.000000, 3.000000, 4.750000);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__Door__pf), true, 0));
	bpv__DoorCollider__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__DoorCollider__pf->AttachToComponent(bpv__Door__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__DoorCollider__pf->AreaClass = UNavArea_Obstacle::StaticClass();
	auto& __Local__7 = (*(AccessPrivateProperty<FVector >((bpv__DoorCollider__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__7 = FVector(0.000000, 0.000000, 2.105263);
	auto& __Local__8 = (*(AccessPrivateProperty<FVector >((bpv__DoorCollider__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__8 = FVector(2.000000, 1.833333, 1.421053);
	(((FBoolProperty*)__Local__0)->SetPropertyValue_InContainer((bpv__DoorCollider__pf), true, 0));
	bpv__DoorPosition_DoorHeight_ECD782D5454C0A60107B9083FD2850B3__pf = 0.000000f;
	bpv__DoorPosition__Direction_ECD782D5454C0A60107B9083FD2850B3__pf = ETimelineDirection::Type::Forward;
	bpv__DoorPosition__pf = nullptr;
	bpv__Level__pf = TSoftObjectPtr<UWorld> (FSoftObjectPath(TEXT("")));
	bpv__DestinationTag__pf = FString(TEXT(""));
	bpv__Key__pf = nullptr;
...
void ATransition_C__pf4069104048::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__DoorCollider__pf)
	{
		bpv__DoorCollider__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ATransition_C__pf4069104048::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__10 = NewObject<UTimelineTemplate>(InDynamicClass, UTimelineTemplate::StaticClass(), TEXT("DoorPosition_Template"), (EObjectFlags)0x00280008);
	...
	auto& __Local__11 = __Local__10->FloatTracks[0];
	auto __Local__12 = NewObject<UCurveFloat>(InDynamicClass, UCurveFloat::StaticClass(), TEXT("CurveFloat_0"), (EObjectFlags)0x00280009);
	InDynamicClass->MiscConvertedSubobjects.Add(__Local__12);
	__Local__12->FloatCurve.Keys = TArray<FRichCurveKey> ();
	__Local__12->FloatCurve.Keys.AddUninitialized(2);
	FRichCurveKey::StaticStruct()->InitializeStruct(__Local__12->FloatCurve.Keys.GetData(), 2);
	auto& __Local__13 = __Local__12->FloatCurve.Keys[0];
	auto& __Local__14 = __Local__12->FloatCurve.Keys[1];
	__Local__14.Time = 1.000000f;
	__Local__14.Value = -200.000000f;
	__Local__11.CurveFloat = __Local__12;
	auto& __Local__15 = (*(AccessPrivateProperty<FName >(&(__Local__11), FTTPropertyTrack::__PPO__PropertyName() )));
	__Local__15 = FName(TEXT("DoorPosition_DoorHeight_ECD782D5454C0A60107B9083FD2850B3"));
	auto& __Local__16 = (*(AccessPrivateProperty<FName >(&(__Local__11), FTTTrackBase::__PPO__TrackName() )));
	__Local__16 = FName(TEXT("DoorHeight"));
	__Local__10->TimelineGuid = FGuid(0xECD782D5, 0x454C0A60, 0x107B9083, 0xFD2850B3);
	auto& __Local__17 = (*(AccessPrivateProperty<FName >((__Local__10), UTimelineTemplate::__PPO__VariableName() )));
	__Local__17 = FName(TEXT("DoorPosition"));
	auto& __Local__18 = (*(AccessPrivateProperty<FName >((__Local__10), UTimelineTemplate::__PPO__DirectionPropertyName() )));
	__Local__18 = FName(TEXT("DoorPosition__Direction_ECD782D5454C0A60107B9083FD2850B3"));
	auto& __Local__19 = (*(AccessPrivateProperty<FName >((__Local__10), UTimelineTemplate::__PPO__UpdateFunctionName() )));
	__Local__19 = FName(TEXT("DoorPosition__UpdateFunc"));
	auto& __Local__20 = (*(AccessPrivateProperty<FName >((__Local__10), UTimelineTemplate::__PPO__FinishedFunctionName() )));
	__Local__20 = FName(TEXT("DoorPosition__FinishedFunc"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ATransition_C__pf4069104048::bpf__ExecuteUbergraph_Transition__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ATransition_C__pf4069104048::bpf__ExecuteUbergraph_Transition__pf_1(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 10);
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_DynamicCast_AsFirst_Person_Character__pf = Cast<AFirstPersonCharacter_C__pf205484891>(b0l__K2Node_Event_OtherActor__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsFirst_Person_Character__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	UGameplayStatics::OpenLevelBySoftObjectPtr(this, bpv__Level__pf, true, bpv__DestinationTag__pf);
	return; // KCST_GotoReturn
}
void ATransition_C__pf4069104048::bpf__ExecuteUbergraph_Transition__pf_2(int32 bpp__EntryPoint__pf)
{
	FText bpfv__CallFunc_Conv_ObjectToText_ReturnValue__pf{};
	FText bpfv__CallFunc_Format_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 8);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_Conv_ObjectToText_ReturnValue__pf = UKismetTextLibrary::Conv_ObjectToText(bpv__Door__pf);
	...
	b0l__K2Node_MakeStruct_FormatArgumentData__pf.ArgumentValue = bpfv__CallFunc_Conv_ObjectToText_ReturnValue__pf;
...
TEXT("NSLOCTEXT(\"[CB88568E4C4B329F8FEBC1851B4A8440]\", \"E26D66C645856674E71F27AD08290245\", \"Press E to open {name}\")")	), b0l__K2Node_MakeArray_Array__pf);
...
void ATransition_C__pf4069104048::bpf__ExecuteUbergraph_Transition__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 7);
	// optimized KCST_UnconditionalGoto
	if(::IsValid(bpv__DoorPosition__pf))
	{
		bpv__DoorPosition__pf->UTimelineComponent::Play();
	}
	return; // KCST_GotoReturn
}
void ATransition_C__pf4069104048::bpf__ExecuteUbergraph_Transition__pf_4(int32 bpp__EntryPoint__pf)
{
	FVector bpfv__CallFunc_MakeVector_ReturnValue__pf(EForceInit::ForceInit);
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(0.000000, 0.000000, bpv__DoorPosition_DoorHeight_ECD782D5454C0A60107B9083FD2850B3__pf);
	if(::IsValid(bpv__Door__pf))
	{
		bpv__Door__pf->USceneComponent::K2_SetRelativeLocation(bpfv__CallFunc_MakeVector_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_SetRelativeLocation_SweepHitResult__pf, false);
	}
	return; // KCST_GotoReturn
}
void ATransition_C__pf4069104048::bpf__ExecuteUbergraph_Transition__pf_5(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 4);
	return; // KCST_GotoReturn
}
void ATransition_C__pf4069104048::bpf__ReceiveActorBeginOverlap__pf(AActor* bpp__OtherActor__pf)
{
	b0l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_Transition__pf_1(10);
}
void ATransition_C__pf4069104048::bpf__LookAt__pf(AFirstPersonCharacter_C__pf205484891* bpp__PlayerCharacter__pf)
{
	b0l__K2Node_Event_PlayerCharacter__pf = bpp__PlayerCharacter__pf;
	bpf__ExecuteUbergraph_Transition__pf_2(8);
}
void ATransition_C__pf4069104048::bpf__OpenDoor__pf()
{
	bpf__ExecuteUbergraph_Transition__pf_3(7);
}
void ATransition_C__pf4069104048::bpf__InteractWith__pf(AFirstPersonCharacter_C__pf205484891* bpp__PlayerCharacter__pf)
{
	b0l__K2Node_Event_PlayerCharacter_1__pf = bpp__PlayerCharacter__pf;
	bpf__ExecuteUbergraph_Transition__pf_0(5);
}
void ATransition_C__pf4069104048::bpf__DoorPosition__UpdateFunc__pf()
{
	bpf__ExecuteUbergraph_Transition__pf_4(1);
}
void ATransition_C__pf4069104048::bpf__DoorPosition__FinishedFunc__pf()
{
	bpf__ExecuteUbergraph_Transition__pf_5(4);
}
PRAGMA_DISABLE_OPTIMIZATION
void ATransition_C__pf4069104048::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{131, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Engine/BasicShapes/Cube.Cube 
		{132, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Engine/BasicShapes/BasicShapeMaterial.BasicShapeMaterial 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ATransition_C__pf4069104048::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{133, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.BoxComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ATransition_C__pf4069104048
{
	FRegisterHelper__ATransition_C__pf4069104048()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Blueprints/Transition/Transition"), &ATransition_C__pf4069104048::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ATransition_C__pf4069104048 Instance;
};
FRegisterHelper__ATransition_C__pf4069104048 FRegisterHelper__ATransition_C__pf4069104048::Instance;
