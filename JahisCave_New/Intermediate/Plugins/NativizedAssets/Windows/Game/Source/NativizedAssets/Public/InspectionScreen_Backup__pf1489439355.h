...
class UTextBlock;
class UScrollBox;
#include "InspectionScreen_Backup__pf1489439355.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/UI/InspectionScreen_Backup.InspectionScreen_Backup_C", OverrideNativeName="InspectionScreen_Backup_C"))
class UInspectionScreen_Backup_C__pf1489439355 : public UUserWidget
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Image_151", Category="InspectionScreen_Backup", OverrideNativeName="Image_151"))
	UImage* bpv__Image_151__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="Image_153", Category="InspectionScreen_Backup", OverrideNativeName="Image_153"))
	UImage* bpv__Image_153__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="ItemDescriptionText", Category="InspectionScreen_Backup", OverrideNativeName="ItemDescriptionText"))
	UTextBlock* bpv__ItemDescriptionText__pf;
	UPROPERTY(BlueprintReadWrite, Export, meta=(DisplayName="ScrollB", Category="InspectionScreen_Backup", OverrideNativeName="ScrollB"))
	...
	UInspectionScreen_Backup_C__pf1489439355(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_InspectionScreen_Backup__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_InspectionScreen_Backup__pf_1(int32 bpp__EntryPoint__pf);
